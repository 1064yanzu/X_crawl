...
def create_queue(*, name: Optional[str], task_payloads: list[dict]) -> dict:
    ...
    for index, payload in enumerate(task_payloads, start=1):
        task_id = task_manager.create_task(
            ...
            time_split_mode=payload.get("time_split_mode", "inherit"),
            time_split_window_days=payload.get("time_split_window_days"),
            time_split_max_segments=payload.get("time_split_max_segments"),
