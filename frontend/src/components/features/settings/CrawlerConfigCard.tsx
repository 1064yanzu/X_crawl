                ...
                {loading ? (
                    ...
                    <>
                        <div className="rounded-[1.25rem] border border-border/60 bg-muted/10 px-4 shadow-sm sm:px-5">
                            ...
                            <ConfigRow label="微博 418 冷却时长" description="微博返回浏览器 HTTP 418 错误页时，自动等待多久后再重试当前页。" value={config.weibo_http_418_cooldown_seconds ?? 600} onChange={set("weibo_http_418_cooldown_seconds")} min={60} max={3600} step={60} />
